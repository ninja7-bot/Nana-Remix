...
@app.on_message(filters.user(AdminSettings) & ~filters.forwarded & ~filters.via_bot & filters.command("eval", Command))
...
@app.on_message(filters.user(AdminSettings) & ~filters.forwarded & ~filters.via_bot & filters.command("sh", Command))
